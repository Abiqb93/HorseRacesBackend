...
function resolveDbConfig() {
  ...
  return {
    ...
    // The database name is not a secret, so it gets a default. DB_NAME was the
    // one variable Railway did not carry, and requiring it took the API down.
    database:
      first("DB_NAME", "MYSQLDATABASE", "MYSQL_DATABASE", "DB_DATABASE") || "horseprofileshub",
...
const missingDbVars = ["host", "user", "password"].filter((k) => !dbConfig[k]);
