...
app.get("/api/hot_form", async (req, res) => {
  ...
  try {
    ...
    hotFormInFlight.delete(cacheKey);
  }
});
...
// NOTE: these are declared above the generic /api/:tableName route below.
// Express matches in declaration order, so a single-segment path like
// /api/pedigree is otherwise swallowed by it and answers "Invalid table
// name" — which is exactly what it did in production until this moved.
